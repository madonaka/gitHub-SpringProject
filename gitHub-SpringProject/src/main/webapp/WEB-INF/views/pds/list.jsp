...
<%@ include file= "../include/login_form.jsp"  %>
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      <tr>
        ...
        <img src="/resources/img/bullet-01.gif"> <b>자 료 실</b></font></td></tr>
      <tr>
		...
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
			...
			<font face="돋움" size="2" color="#000000">${pds.bno }</font></td>
			<td align="left" height="20">&nbsp;
				<font face="돋움" size="2" color="#000000">
				<a class="list" href="/pds/get?bno=${pds.bno}">${pds.title }</a></td>
					<td align="center" height="20"><font face="돋움" size="2">
					<a class="list" href="mailto:ein1027@nate.com">${pds.writer }</a></font></td>
				<td align="center" height="20"><font face="돋움" size="2"><fmt:formatDate value="${pds.regdate }" pattern="yyyy-MM-dd hh:mm"/></font></td>
				<td align="center" height="20"><font face="돋움" size="2">
				3</font></td>
		</tr>
		</c:forEach>
             ...
             <td colspan="5">        
                <div align="center">
                	<c:if test="${pageMaker.prev}">
                		<a href="/pds/list${pageMaker.makeQuery(pageMaker.startPage - 1)}"> 이전</a>
                	</c:if>
                	<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
				    	<a href="/pds/list${pageMaker.makeQuery(idx)}">${idx}</a></li>
				    </c:forEach>
				    <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
				    	<a href="/pds/list${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
				    </c:if>               
	...
	<table width="600">
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name="searchForm" action="/pds/list" method="get">	
